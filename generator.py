...
randomwgt = QWidget()
randomlyt = QHBoxLayout()
randomlbl = QLabel('Рандомный мастер-пароль')
random = QRadioButton()
random.setChecked(True)
randomlyt.addWidget(randomlbl)
randomlyt.addWidget(random)
randomwgt.setLayout(randomlyt)
layout.addWidget(randomwgt)
